...
const messages: TranslationMap = {
  ...
  'modelCouncil.title': 'Dewan Model',
  'modelCouncil.intro':
    'Ajukan satu pertanyaan, dapatkan jawaban independen dari beberapa model secara paralel, lalu model ketua mensintesis di mana mereka sepakat, tidak sepakat, dan apa yang ditambahkan masing-masing secara unik.',
  'modelCouncil.listTitle': 'Councils',
  'modelCouncil.listIntro':
    'Pilih dewan tersimpan, edit agen dan hakimnya, atau buat dewan baru untuk jenis keputusan tertentu.',
  'modelCouncil.addCouncil': 'Dewan baru',
  'modelCouncil.openCouncil': 'Buka dewan',
  'modelCouncil.editCouncil': 'Edit dewan',
  'modelCouncil.editCurrentCouncil': 'Edit dewan saat ini',
  'modelCouncil.editCouncilAria': 'Edit {name}',
  'modelCouncil.deleteCouncilAria': 'Hapus {name}',
  'modelCouncil.backToCouncils': 'Kembali ke daftar dewan',
  'modelCouncil.saveCouncil': 'Simpan dewan',
  'modelCouncil.savingCouncil': 'Saving…',
  'modelCouncil.cancelEdit': 'Cancel',
  'modelCouncil.loadingCouncils': 'Memuat dewan…',
  'modelCouncil.noCouncils': 'Belum ada dewan. Tambahkan satu untuk memulai.',
  'modelCouncil.noCouncilDescription': 'Tanpa deskripsi',
  'modelCouncil.registryErrorPrefix': 'Registri dewan gagal:',
  'modelCouncil.councilNameLabel': 'Nama dewan',
  'modelCouncil.councilDescriptionLabel': 'Description',
  'modelCouncil.councilDescriptionPlaceholder': 'Kapan menggunakan dewan ini',
  'modelCouncil.selectModel': 'Select',
  'modelCouncil.modelPickerHelp': 'Pilih petunjuk routing atau pin model penyedia yang tepat.',
  ...
  'modelCouncil.modelIdLabel': 'ID model',
  'modelCouncil.useProviderModel': 'Gunakan model penyedia',
  'modelCouncil.questionLabel': 'Question',
  'modelCouncil.questionPlaceholder': 'Ajukan pertanyaan ke dewan…',
  'modelCouncil.membersLabel': 'Model anggota',
  'modelCouncil.maxMembersNote': 'hingga {max}',
  'modelCouncil.memberPlaceholder': 'mis. gpt-5.2',
  'modelCouncil.memberAria': 'Model anggota {n}',
  'modelCouncil.removeMemberAria': 'Hapus model anggota {n}',
  'modelCouncil.addMember': '+ Tambah model',
  ...
  'modelCouncil.debateRoundsLabel': 'Putaran debat',
  'modelCouncil.debateRoundsHelp':
    'Setiap juri terus berdebat lintas putaran sebelum hakim menulis sintesis akhir.',
  ...
  'modelCouncil.liveScratchpadHelp':
    'Pembaruan juri ditambahkan di sini setelah setiap putaran, lalu dimasukkan ke putaran berikutnya.',
  'modelCouncil.liveScratchpadBadge': 'Live',
  'modelCouncil.scratchpadRoundHeading': 'Pembaruan putaran {round}',
  'modelCouncil.scratchpadNoResponse': 'Tidak ada respons',
  'modelCouncil.chairLabel': 'Model ketua',
  'modelCouncil.chairPlaceholder': 'mis. claude-opus-4-8',
  'modelCouncil.chairHelp': 'Ketua membaca setiap jawaban anggota dan menulis sintesis.',
  'modelCouncil.run': 'Kumpulkan dewan',
  'modelCouncil.running': 'Convening…',
  'modelCouncil.runningHint': 'Menanyai anggota secara paralel, lalu mensintesis…',
  'modelCouncil.deliberationHeading': 'Deliberasi dewan',
  'modelCouncil.deliberationHelp':
    'Maskot menunjukkan setiap agen sedang berpikir saat file penalaran bersama sedang digunakan.',
  'modelCouncil.debateRoundInstruction':
    'Tanggapi juri lainnya. Pertahankan ketidaksepakatan, revisi pandangan Anda jika beralasan, dan tetap eksplisitkan kesimpulan Anda saat ini.',
  'modelCouncil.debateFinalInstruction':
    'Ini adalah putaran juri terakhir Anda. Konvergensi di mana bukti mendukung, sebutkan ketidaksepakatan yang tersisa, dan berikan hakim kesimpulan yang jelas.',
  'modelCouncil.roundLabel': 'Putaran {round}',
  'modelCouncil.currentRoundThinking': 'Melanjutkan putaran berikutnya…',
  'modelCouncil.thinkingBadge': 'Thinking',
  'modelCouncil.thinkingWithBrief': 'Bekerja dari perspektif ini: {brief}',
  'modelCouncil.thought.evidence':
    'Memeriksa bukti, asumsi, dan apa yang sudah tercatat dalam file penalaran bersama.',
  'modelCouncil.thought.plan': 'Merancang jalur praktis dan di mana eksekusi bisa terhambat.',
  'modelCouncil.thought.risk':
    'Mencari modus kegagalan, konteks yang hilang, dan kesimpulan yang rapuh.',
  'modelCouncil.thought.tradeoffs':
    'Membandingkan pertukaran sebelum memberikan hakim posisi yang ringkas.',
  'modelCouncil.thought.synthesis':
    'Menyiapkan pandangan berbeda agar hakim dapat membandingkan ketidaksepakatan nyata.',
  'modelCouncil.judgeWaitingBadge': 'Judge',
  'modelCouncil.judgeWaitingThought':
    'Menunggu jawaban juri, lalu membaca file penalaran bersama untuk sintesis.',
  'modelCouncil.judgeSynthesizingBadge': 'Synthesizing',
  'modelCouncil.judgeSynthesizingThought':
    'Membaca pemikiran langsung juri dan menulis sintesis akhir dewan.',
  'modelCouncil.errorPrefix': 'Dewan gagal:',
  'modelCouncil.resultsHeading': 'Hasil dewan',
  'modelCouncil.memberAnswered': 'Answered',
  'modelCouncil.memberFailed': 'Failed',
  'modelCouncil.synthesisHeading': 'Synthesis',
  'modelCouncil.synthesisBy': 'oleh {model}',
  'modelCouncil.usageHeading': 'Penggunaan debat',
  'modelCouncil.usageEstimated':
    'Perkiraan jumlah token dari prompt dan respons debat. Harga sebenarnya memerlukan penggunaan penyedia dari RPC dewan.',
  'modelCouncil.usageEstimatedBadge': 'Estimasi token',
