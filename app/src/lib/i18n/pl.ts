...
const messages: TranslationMap = {
  ...
  'modelCouncil.title': 'Rada modeli',
  'modelCouncil.intro':
    'Zadaj jedno pytanie, uzyskaj niezależne odpowiedzi od kilku modeli równolegle, a następnie model przewodniczącego syntetyzuje, w czym się zgadzają, gdzie się różnią i co każdy wnosi unikalnie.',
  'modelCouncil.listTitle': 'Councils',
  'modelCouncil.listIntro':
    'Wybierz zapisaną radę, edytuj jej agentów i sędziego lub utwórz nową radę dla konkretnego rodzaju decyzji.',
  'modelCouncil.addCouncil': 'Nowa rada',
  'modelCouncil.openCouncil': 'Otwórz radę',
  'modelCouncil.editCouncil': 'Edytuj radę',
  'modelCouncil.editCurrentCouncil': 'Edytuj bieżącą radę',
  'modelCouncil.editCouncilAria': 'Edytuj {name}',
  'modelCouncil.deleteCouncilAria': 'Usuń {name}',
  'modelCouncil.backToCouncils': 'Powrót do rad',
  'modelCouncil.saveCouncil': 'Zapisz radę',
  'modelCouncil.savingCouncil': 'Saving…',
  'modelCouncil.cancelEdit': 'Cancel',
  'modelCouncil.loadingCouncils': 'Ładowanie rad…',
  'modelCouncil.noCouncils': 'Brak rad. Dodaj jedną, aby rozpocząć.',
  'modelCouncil.noCouncilDescription': 'Brak opisu',
  'modelCouncil.registryErrorPrefix': 'Rejestr rady nie powiódł się:',
  'modelCouncil.councilNameLabel': 'Nazwa rady',
  ...
  'modelCouncil.modelIdLabel': 'ID modelu',
  'modelCouncil.useProviderModel': 'Użyj modelu dostawcy',
  'modelCouncil.questionLabel': 'Question',
  'modelCouncil.questionPlaceholder': 'Zadaj radzie pytanie…',
  'modelCouncil.membersLabel': 'Modele członków',
  'modelCouncil.maxMembersNote': 'do {max}',
  'modelCouncil.memberPlaceholder': 'np. gpt-5.2',
  'modelCouncil.memberAria': 'Model członka {n}',
  'modelCouncil.removeMemberAria': 'Usuń model członka {n}',
  'modelCouncil.addMember': '+ Dodaj model',
  ...
  'modelCouncil.debateRoundsLabel': 'Rundy debaty',
  'modelCouncil.debateRoundsHelp':
    'Każdy ławnik debatuje przez wiele rund, zanim sędzia napisze końcową syntezę.',
  ...
  'modelCouncil.jurorLabel': 'Ławnik {n}',
  ...
  'modelCouncil.liveScratchpadHelp':
    'Aktualizacje ławników są tutaj dodawane po każdej rundzie i zasilają następną rundę.',
  'modelCouncil.liveScratchpadBadge': 'Live',
  'modelCouncil.scratchpadRoundHeading': 'Aktualizacje rundy {round}',
  'modelCouncil.scratchpadNoResponse': 'Brak odpowiedzi',
  'modelCouncil.chairLabel': 'Model przewodniczącego',
  'modelCouncil.chairPlaceholder': 'np. claude-opus-4-8',
  'modelCouncil.chairHelp': 'Przewodniczący czyta każdą odpowiedź członków i pisze syntezę.',
  'modelCouncil.run': 'Zwołaj radę',
  'modelCouncil.running': 'Convening…',
  'modelCouncil.runningHint': 'Odpytywanie członków równolegle, następnie synteza…',
  'modelCouncil.deliberationHeading': 'Obrady rady',
  'modelCouncil.deliberationHelp':
    'Maskotki pokazują myślenie każdego agenta, gdy wspólny plik rozumowania jest w użyciu.',
  'modelCouncil.debateRoundInstruction':
    'Odpowiedz innym ławnikom. Zachowaj rozbieżności, zrewiduj swój pogląd, gdy to uzasadnione, i utrzymaj swój aktualny wniosek w sposób jawny.',
  'modelCouncil.debateFinalInstruction':
    'To Twoja ostatnia runda ławnika. Zbieżność tam, gdzie dowody to wspierają, wskaż pozostałe rozbieżności i przekaż sędziemu jasny wniosek.',
  'modelCouncil.roundLabel': 'Runda {round}',
  'modelCouncil.currentRoundThinking': 'Kontynuowanie następnej rundy…',
  ...
  'modelCouncil.thought.synthesis':
    'Przygotowanie odrębnego punktu widzenia, aby sędzia mógł porównać rzeczywiste rozbieżności.',
  'modelCouncil.judgeWaitingBadge': 'Judge',
  'modelCouncil.judgeWaitingThought':
    'Oczekiwanie na odpowiedzi ławników, następnie czytanie wspólnego pliku rozumowania w celu syntezy.',
  'modelCouncil.judgeSynthesizingBadge': 'Synthesizing',
  'modelCouncil.judgeSynthesizingThought':
    'Czytanie myśli ławników na żywo i pisanie końcowej syntezy rady.',
  'modelCouncil.errorPrefix': 'Rada nie powiodła się:',
  'modelCouncil.resultsHeading': 'Wyniki rady',
  'modelCouncil.memberAnswered': 'Answered',
  'modelCouncil.memberFailed': 'Failed',
  'modelCouncil.synthesisHeading': 'Synthesis',
  'modelCouncil.synthesisBy': 'przez {model}',
  'modelCouncil.usageHeading': 'Użycie debaty',
  'modelCouncil.usageEstimated':
    'Szacunkowa liczba tokenów z promptów i odpowiedzi debaty. Rzeczywista wycena wymaga danych o użyciu dostawcy z RPC rady.',
  'modelCouncil.usageEstimatedBadge': 'Szacunkowe tokeny',
