...
const messages: TranslationMap = {
  ...
  'modelCouncil.title': 'Consejo de modelos',
  'modelCouncil.intro':
    'Haz una pregunta, obtén respuestas independientes de varios modelos en paralelo, y luego el modelo presidente sintetiza dónde coinciden, dónde discrepan y qué aporta cada uno.',
  'modelCouncil.listTitle': 'Consejos',
  'modelCouncil.listIntro':
    'Elige un consejo guardado, edita sus agentes y juez, o crea uno nuevo para un tipo específico de decisión.',
  'modelCouncil.addCouncil': 'Nuevo consejo',
  'modelCouncil.openCouncil': 'Abrir consejo',
  'modelCouncil.editCouncil': 'Editar consejo',
  'modelCouncil.editCurrentCouncil': 'Editar consejo actual',
  'modelCouncil.editCouncilAria': 'Editar {name}',
  'modelCouncil.deleteCouncilAria': 'Eliminar {name}',
  'modelCouncil.backToCouncils': 'Volver a los consejos',
  'modelCouncil.saveCouncil': 'Guardar consejo',
  'modelCouncil.savingCouncil': 'Guardando…',
  'modelCouncil.cancelEdit': 'Cancelar',
  'modelCouncil.loadingCouncils': 'Cargando consejos…',
  'modelCouncil.noCouncils': 'Aún no hay consejos. Agrega uno para empezar.',
  ...
  'modelCouncil.modelProviderLabel': 'Proveedor del modelo',
  'modelCouncil.modelIdLabel': 'ID del modelo',
  'modelCouncil.useProviderModel': 'Usar modelo del proveedor',
  'modelCouncil.questionLabel': 'Pregunta',
  'modelCouncil.questionPlaceholder': 'Haz una pregunta al consejo…',
  'modelCouncil.membersLabel': 'Modelos miembros',
  'modelCouncil.maxMembersNote': 'hasta {max}',
  'modelCouncil.memberPlaceholder': 'ej. gpt-5.2',
  'modelCouncil.memberAria': 'Modelo miembro {n}',
  'modelCouncil.removeMemberAria': 'Eliminar modelo miembro {n}',
  'modelCouncil.addMember': '+ Agregar modelo',
  ...
  'modelCouncil.debateRoundsLabel': 'Rondas de debate',
  'modelCouncil.debateRoundsHelp':
    'Cada jurado sigue debatiendo en rondas antes de que el juez escriba la síntesis final.',
  ...
  'modelCouncil.liveScratchpadHelp':
    'Las actualizaciones de los jurados se agregan aquí después de cada ronda y se usan en la siguiente.',
  'modelCouncil.liveScratchpadBadge': 'Live',
  'modelCouncil.scratchpadRoundHeading': 'Actualizaciones de la ronda {round}',
  ...
  'modelCouncil.deliberationHeading': 'Deliberación del consejo',
  'modelCouncil.deliberationHelp':
    'Las mascotas muestran a cada agente pensando mientras el archivo de razonamiento compartido está en uso.',
  'modelCouncil.debateRoundInstruction':
    'Responde a los otros jurados. Mantén los desacuerdos, revisa tu postura cuando sea justificado y deja tu conclusión actual explícita.',
  'modelCouncil.debateFinalInstruction':
    'Esta es tu última ronda como jurado. Converge donde la evidencia lo respalde, señala desacuerdos restantes y dale al juez una conclusión clara.',
  'modelCouncil.roundLabel': 'Ronda {round}',
  'modelCouncil.currentRoundThinking': 'Continuando la siguiente ronda…',
  'modelCouncil.thinkingBadge': 'Pensando',
  'modelCouncil.thinkingWithBrief': 'Trabajando desde esta perspectiva: {brief}',
  'modelCouncil.thought.evidence':
    'Revisando evidencia, suposiciones y lo que el archivo de razonamiento compartido ya contiene.',
  'modelCouncil.thought.plan': 'Trazando el camino práctico y dónde la ejecución podría atascarse.',
  'modelCouncil.thought.risk':
    'Buscando modos de fallo, contexto faltante y conclusiones frágiles.',
  'modelCouncil.thought.tradeoffs':
    'Comparando compromisos antes de entregar al juez una posición concisa.',
  'modelCouncil.thought.synthesis':
    'Preparando una vista distinta para que el juez compare desacuerdos reales.',
  'modelCouncil.judgeWaitingBadge': 'Juez',
  'modelCouncil.judgeWaitingThought':
    'Esperando las respuestas de los jurados, luego leyendo el archivo de razonamiento compartido para sintetizar.',
  'modelCouncil.judgeSynthesizingBadge': 'Sintetizando',
  'modelCouncil.judgeSynthesizingThought':
    'Leyendo los pensamientos en vivo de los jurados y redactando la síntesis final del consejo.',
  'modelCouncil.errorPrefix': 'El consejo falló:',
  ...
  'modelCouncil.usageEstimated':
    'Conteos de tokens estimados de los prompts y respuestas del debate. El precio real requiere el uso del proveedor desde el RPC del consejo.',
